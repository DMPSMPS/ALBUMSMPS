...
Snd_NewSpecialS_Jump00:
	smpsSetvoice        $04
	smpsAlterVol        $04
	dc.b	nRst, $0C, nRst, $04, nRst, nRst, $1C, nG4, $08, nE4, $04, nG5
	dc.b	$08, nFs4, $1C
	smpsAlterPitch      $F4
	smpsSetvoice        $05
	smpsAlterVol        $FC
...
Snd_NewSpecialS_Loop0B:
	...
	dc.b	$08, nFs5, nRst, $04, nA5, $08, nRst, $04, nB5, $08, nRst, $04
...
Snd_NewSpecialS_Loop0A:
	dc.b	nRst, $04, nE5, $08
	smpsLoop            $00, $03, Snd_NewSpecialS_Loop0A
	dc.b	nB4, $04, nD5, $08, nE5, $2C, nRst, $08, nA5, nRst, $04, nB5
	dc.b	$08, nRst, $04, nD6, $08, nRst, $04, nG5, $08, nA5, $0C, nFs5
	dc.b	$08, smpsNoAttack, nFs5, nD5, $08, nRst, $04, nFs5, $08, nRst, $04, nA5
	dc.b	$08, nRst, $04, nB5, $08, nRst, $04, nD6, $08, nRst, $04, nA5
	dc.b	$08, nD6, $04, nRst, nRst, nC6, $08, smpsNoAttack, nC6, nB5, $08, nRst
	dc.b	$04, nA5, $08, nRst, $04, nB5, $08, nRst, $04, nB5, $08, nRst
	dc.b	$04, nD6, $08, nRst, $04, nB5, $08, nFs6, $04, nRst, nRst, nD6
	dc.b	$08, smpsNoAttack, nD6, nFs5, $08, nRst, $04, nB5, $08, nRst, $04, nA5
	dc.b	$08, nRst, $04, nG5, $08, nRst, $04, nFs5, $08, nRst, $04, nD5
	dc.b	$08, nRst, $04, nFs5, $08, nAb5, $0C, nA5, $04, nRst, nRst, nB5
	dc.b	$08, nRst
	dc.b	$FB 
	dc.b	$02
	...
	dc.b	$04, nFs6, $08, nA6, $04, nRst, nRst, nB6, $0C, nD7, $04, nRst
	dc.b	nRst, nD7, nB6, $0C, nA6, nFs6, $08, nRst, $04, nG6, $08, nA6
	dc.b	$04, nB6, $08, nD7, $04, nRst, nRst, nE7, $0C, nG7, $04, $0C
	dc.b	nFs7, nE7, nD7, nG7, $5C, nRst, $04
	smpsAlterVol        $03
	smpsAlterPitch      $0C
...
Snd_NewSpecialS_Loop0D:
	dc.b	nRst, $04, nE5, $08
	smpsLoop            $00, $03, Snd_NewSpecialS_Loop0D
	dc.b	nB4, $04, nD5, $08, nE5, $2C, nRst, $08, nA5, nRst, $04, nB5
	dc.b	$08, nRst, $04, nD6, $08, nRst, $04, nG5, $08, nA5, $0C, nFs5
	dc.b	$08, smpsNoAttack, nFs5, nD5, $08, nRst, $04, nFs5, $08, nRst, $04, nA5
	dc.b	$08, nRst, $04, nB5, $08, nRst, $04, nD6, $08, nRst, $04, nA5
...
Snd_NewSpecialS_Loop08:
	smpsPan             panRight, $00
	smpsSetvoice        $01
	dc.b	nG4, $08, $04, nRst, nRst, nG4, $18, nRst, $04, nG4, $0C, nFs4
	dc.b	nE4
	smpsSetvoice        $02
	dc.b	nFs4
	smpsSetvoice        $01
	dc.b	$08, $04, nRst, nRst, nFs4, $18, nRst, $04, nFs4, $0C, nE4, nFs4
	smpsSetvoice        $02
	dc.b	nA4
	smpsSetvoice        $01
	dc.b	nF4, $08, $04, nRst, nRst, nF4, $18, nRst, $04, nF4, $0C, nD4
	dc.b	nE4
	smpsSetvoice        $02
	dc.b	nF4
	smpsSetvoice        $01
	dc.b	nE4, nE4, nD4, $08, nG3, $04, nA3, $08, nB3, $34, nD5, $08
	dc.b	$04, nRst, nRst, nD5, $18, nRst, $04, nD5, $0C, nCs5, nB4
	smpsSetvoice        $02
	dc.b	nA4
	smpsSetvoice        $01
	dc.b	nC5, $08, $04, nRst, nRst, nC5, $18, nRst, $04, nC5, $0C, nB4
	dc.b	nC5
	smpsSetvoice        $02
	dc.b	nE5
	smpsSetvoice        $01
	dc.b	nB4, $08, $04, nRst, nRst, nB4, $18, nRst, $04, nB4, $0C, nA4
	dc.b	nB4
	smpsSetvoice        $02
	dc.b	nD5
	smpsSetvoice        $01
...
Snd_NewSpecialS_Loop07:
	...
	dc.b	$FB 
	dc.b	$FC 
	dc.b	$08, $04, nRst, nRst, nB4, $18, nRst, $04, nB4, $0C, nBb4, nAb4
	dc.b	$08, nBb4, $04
	smpsSetvoice        $02
	dc.b	nB4, $0C
	smpsSetvoice        $01
	dc.b	$08, $04, nRst, nRst, nB4, $18, nRst, $04, nB4, $0C, nBb4, nB4
	dc.b	$08, nCs5, $04
	smpsSetvoice        $02
	dc.b	nB4, $0C
	smpsSetvoice        $01
	...
	dc.b	nB4, $0C
	smpsSetvoice        $01
	dc.b	nBb4, $08, $04, nRst, nRst, nBb4, $18, nRst, $04, nBb4, $0C, nAb4
	dc.b	nBb4, $08, nCs5, $04
	smpsSetvoice        $02
	dc.b	nBb4, $0C
	smpsSetvoice        $01
	dc.b	nB4, $08, $04, nRst, nRst, nB4, $18, nRst, $04, nB4, $0C, nBb4
	dc.b	nAb4, $08, nBb4, $04
	smpsSetvoice        $02
	dc.b	nB4, $0C
	smpsSetvoice        $01
	dc.b	nA4, $08, $04, nRst, nRst, nA4, $18, nRst, $04, nA4, $0C, nAb4
	dc.b	nA4, $08, nB4, $04
	smpsSetvoice        $02
	dc.b	nA4, $0C
	smpsSetvoice        $01
	dc.b	nB4, $08, $04, nRst, nRst, nB4, $18, nRst, $04, nB4, $0C, nB4
	dc.b	nB4
	smpsSetvoice        $02
	dc.b	nB4
	smpsSetvoice        $01
	...
	dc.b	$FE 
	dc.b	nB4, $08, $04, nRst, nRst, nB4, $18, nRst, $04, nB4, $0C, nBb4
	dc.b	nAb4, $08, nBb4, $04, nAb4, $08, nBb4, $04, nB4, $08, $04, nRst
	dc.b	nRst, nB4, $18, nRst, $04, nB4, $0C, nBb4, nB4, $08, nCs5, $04
	dc.b	nEb5, $08, nCs5, $04, nB4, $08, $04, nRst, nRst, nB4, $18, nRst
	dc.b	$04, nB4, $0C, nBb4, nAb4, $08, nBb4, $04, nAb4, $08, nBb4, $04
	dc.b	$08, $04, nRst, nRst, nBb4, $18, nRst, $04, nBb4, $0C, nAb4, nBb4
	dc.b	$08, nCs5, $04, nEb5, $08, nCs5, $04, nB4, $08, $04, nRst, nRst
	dc.b	nB4, $18, nRst, $04, nB4, $0C, nBb4, nAb4, $08, nBb4, $04, nAb4
	dc.b	$08, nBb4, $04, nA4, $08, $04, nRst, nRst, nA4, $18, nRst, $04
	dc.b	nA4, $0C, nAb4, nA4, $08, nB4, $04, nCs5, $08, nA4, $04, nB4
	dc.b	$08, $04, nRst, nRst, nB4, $18, nRst, $04, nB4, $0C, nB4, nB4
	dc.b	nB4, nB4, $08, $04, nRst, nRst, nB4, $0C, $04, $08, nRst, $10
	dc.b	nB4, $08, nRst, nRst, $04, nB4, $08, nRst
	smpsAlterVol        $FB
...
Snd_NewSpecialS_Loop02:
	dc.b	$08, $04, nRst, nRst, nFs4, $18, nRst, $04, nFs4, $0C, nFs4, nFs4
	smpsSetvoice        $02
	dc.b	nFs4
	smpsSetvoice        $01
...
Snd_NewSpecialS_Loop03:
	...
	dc.b	$FB 
	dc.b	$FC 
	dc.b	nFs4, $08, $04, nRst, nRst, nFs4, $18, nRst, $04, nFs4, $0C, nFs4
	dc.b	nFs4, $08, $04
	smpsSetvoice        $02
	dc.b	$0C
	smpsSetvoice        $01
	dc.b	nAb4, $08, $04, nRst, nRst, nAb4, $18, nRst, $04, nAb4, $0C, nAb4
	dc.b	nAb4
...
Snd_NewSpecialS_Loop05:
	...
	dc.b	$FE 
	dc.b	nFs4, $08, $04, nRst, nRst, nFs4, $18, nRst, $04, nFs4, $0C, nFs4
	dc.b	nFs4, $08, $04, $08, $04, nAb4, $08, $04, nRst, nRst, nAb4, $18
	dc.b	nRst, $04, nAb4, $0C, nAb4, nAb4

Snd_NewSpecialS_Loop06:
	dc.b	$08, $04, $08, $04, nFs4, $08, $04, nRst, nRst, nFs4, $18, nRst
	dc.b	$04, nFs4, $0C, nFs4
	smpsLoop            $00, $04, Snd_NewSpecialS_Loop06
	dc.b	nFs4, $08, $04, $08, $04, nG4, $08, $04, nRst, nRst, nG4, $18
	dc.b	nRst, $04, nG4, $0C, nFs4, nE4, nFs4, nG4, $08, $04, nRst, nRst
	dc.b	nG4, $0C, $04, $08, nRst, $10, nG4, $08, nRst, nRst, $04, nG4
	dc.b	$08, nRst
	smpsAlterVol        $FB
...
Snd_NewSpecialS_Loop0E:
	dc.b	nG6, $0C, nRst, nG6, nRst, $04, nRst, nG6, nRst, nRst, nG6, $0C
	dc.b	nRst, $04, nG6, $0C, nRst, $04, nRst, nG6
	smpsLoop            $01, $07, Snd_NewSpecialS_Loop0E
	dc.b	nG6, $0C, nRst, nG6, nRst, $04, nRst, nG6, nRst, nRst, nG6, $0C
	dc.b	nG6, nRst, $04, nG6, $0C
	smpsLoop            $00, $03, Snd_NewSpecialS_Loop0E
	smpsJump            Snd_NewSpecialS_Loop0E
...
;	$00, $08, $00, $0C, 	$0F, $FF, $0F, $0F, 	$1C, $80, $23, $82
	smpsVcAlgorithm     $04
	smpsVcFeedback      $07
	smpsVcUnusedBits    $00
	smpsVcDetune        $00, $00, $00, $00
