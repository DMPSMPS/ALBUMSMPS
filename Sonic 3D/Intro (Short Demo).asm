Snd_Title_Header:
	...
	smpsHeaderFM        Snd_Title_FM1,	$D8, $0B
	...
	smpsHeaderPSG       Snd_Title_PSG1,	$00, $02, $00, $00
	smpsHeaderPSG       Snd_Title_PSG2,	$00, $04, $00, $00
...
Snd_Title_Call00:
	dc.b    nC1, $03, nRst, nC1, nRst, nC2, smpsNoAttack, nC2, nC1, nC2, nC1, nC2
	dc.b    nC1, smpsNoAttack, nC1, nC2, smpsNoAttack, nC2, nC1, nC2
	smpsReturn

Snd_Title_Call01:
	dc.b    nB0, $03, nRst, nB0, nRst, nB1, smpsNoAttack, nB1, nB0, nB1, nB0, nB1
	dc.b    nB0, smpsNoAttack, nB0, nB1, smpsNoAttack, nB1, nB0, nB1
	smpsReturn

Snd_Title_Call02:
	dc.b    nAb0, $03, nRst, nAb0, nRst, nAb1, smpsNoAttack, nAb1, nAb0, nAb1, nAb0, nAb1
	dc.b    nAb0, smpsNoAttack, nAb0, nAb1, smpsNoAttack, nAb1, nAb0, nAb1
	smpsReturn

Snd_Title_Call03:
	dc.b    nG0, $03, nRst, nG0, nRst, nG1, smpsNoAttack, nG1, nG0, nG1, nG0, nG1
...
Snd_Title_Loop02:
	...
	dc.b    nG4, $06, nG5, nF5, nE5, smpsNoAttack, nE5, nF5, nE5
	smpsModSet          $07, $01, $09, $05
	dc.b    nC5, smpsNoAttack, nC5, $0C
	smpsModSet          $0C, $01, $F0, $FD
	dc.b    smpsNoAttack, nC5
	smpsModSet          $0C, $01, $F8, $FD
	dc.b    nRst, $0C, nB4
	smpsModSet          $07, $01, $03, $05
	dc.b    nG4, $06, nG5, nF5, nE5, smpsNoAttack, nE5, nF5, nE5, nC5
	smpsModSet          $07, $01, $09, $05
	dc.b    nD5, $0C
...
Snd_Title_Loop01:
	...
	dc.b    nRst, $0C, nG4
	smpsModSet          $07, $01, $03, $05
	dc.b    nE4, $06, nE5, nD5, nC5, smpsNoAttack, nC5, nD5, nC5
	smpsModSet          $0C, $01, $05, $05
	dc.b    nG4, smpsNoAttack, nG4, $0C
	smpsModSet          $0C, $01, $F0, $FD
	dc.b    smpsNoAttack, nG4
	smpsModSet          $0C, $01, $F8, $FD
	dc.b    nRst, $0C, nG4
	smpsModSet          $07, $01, $03, $05
	dc.b    nD4, $06, nD5, nD5, nC5, smpsNoAttack, nC5, nD5, nC5, nG4
	smpsModSet          $07, $01, $09, $05
	dc.b    nA4, $0C
	smpsModSet          $0C, $01, $F0, $FF
...
Snd_Title_FM4:
	...
	dc.b    nC5, smpsNoAttack, nC5, $0C
	smpsModSet          $0C, $01, $F0, $FD
	dc.b    smpsNoAttack, nC5, $09, nRst, $04
	smpsModSet          $0C, $01, $F8, $FD
	dc.b    nRst, $0C, nB4
	smpsModSet          $07, $01, $03, $05
	dc.b    nG4, $06, nG5, nF5, nE5, smpsNoAttack, nE5, nF5, nE5, nC5
...
Snd_Title_FM5:
	...
	smpsAlterNote       $02
	smpsSetvoice        $03
	dc.b    nRst, $30, nRst, nRst, $30, nRst, nRst, nRst
	smpsPan             panLeft, $00
	dc.b    nAb2, $30, nG2
	smpsModSet          $07, $01, $09, $07
	dc.b    nC3, smpsNoAttack, nC3
...
Snd_Title_PSG1:
	...
	dc.b    nRst, $30, nRst, $2D, nRst, $03

Snd_Title_Loop05:
	dc.b    nG2, $06, nE3, nG2, nE3, nG2, nE3, nG2, nE3
	smpsLoop            $00, $02, Snd_Title_Loop05

Snd_Title_Loop06:
	dc.b    nB2, nF3, nB2, nF3, nB2, nF3, nB2, nF3
	smpsLoop            $00, $02, Snd_Title_Loop06
	dc.b    nAb2, $30, nG2, nG2, $06, nE3, nG2, nE3, nG2, nE3, nG2, nE3
	dc.b    nG2, $06, nE3, nG2, nE3, nG2, nE3, nG2, nE3
	smpsStop
...
Snd_Title_PSG2:
	smpsPSGvoice        sTone_03
	dc.b    nRst, $30, nRst, nRst, $03

Snd_Title_Loop04:
	dc.b    nG3, $06, nC3, nG3, nC3, nG3, nC3, nG3, nC3
	smpsLoop            $00, $02, Snd_Title_Loop04
	dc.b    nG3, nD3, nG3, nD3, nG3, nD3, nG3, nD3, nG3, nD3, nG3, nD3
	dc.b    nG3, nD3, nG3, nD3, $03, nEb2, $30, nD2, nRst, $03, nG3, $06
...
Snd_Title_DAC:
	smpsPan             panCenter, $00
	dc.b    dKickS3, $03, nRst, dKickS3, nRst, dMuffledSnare, nRst, dKickS3, dMuffledSnare, nRst, dMuffledSnare, dKickS3
	dc.b    nRst, dMuffledSnare, dKickS3, dMuffledSnare, nRst, dKickS3, nRst, dKickS3, nRst, dMuffledSnare, nRst, dKickS3
	dc.b    dMuffledSnare, nRst, dMuffledSnare, dKickS3, nRst, dMuffledSnare, dMuffledSnare, dMuffledSnare, dMuffledSnare, dIntroKick, $03, nRst
